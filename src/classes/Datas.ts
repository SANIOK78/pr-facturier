...
export class Datas implements HasHtmlFormat {
    constructor(
        private documentType: string,  //"facture " ou "devis"
        ...
        private tva: number,
        private date: Date,    //date quand on a généré le document
    ...
    private subTotal(price: number, quantity: number, tva: number): number {
        ...
        // Calcule % prix en fonction de la tva
        const totalTva = price * tvaPercent;
        // return le prix total TTC n fonction de la quantité
        return (price + totalTva) * quantity
    }

    // méthode qui va nous générer notre "tempate" sous forme de "string"
    htmlFormat(): string {

        // Calculer le sous-total TTC
        const totalPrix = this.subTotal(this.price, this.quantity, this.tva);
        ...
        return `
            <div class="row p-5">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <p class="font-weight-bold mb-1">Date 
                        <span class="font-weight-normal"> 
            ...
            <div class="d-flex flex-row-reverse bg-light p-4">
                <div class="py-3 px-5">
                    ...
                    <div class="h2 font-weight-light">${ totalPrix.toFixed(2)} €</div>
                </div>
            </div>
        `;       
    }
